...
<ul>            
	...
	<td>   
		...
		<p class="title">Main</p>
			<ul> 
				<li><a href="/pageWep/product/main.do?type=OUT">OUTTER</a></li>
	...
	<td>
		...
		<p class="title">MyPage</p>
			<ul> 
				<li><a href="/pageWep/member/mypage.do">마이페이지</a></li>
				<li><a href="/pageWep/member/modifyForm.do">정보수정</a></li>
				<li><a href="/pageWep/member/deleteForm.do">회원탈퇴</a></li>
				<li><a href="/pageWep/cart/cart.do">장바구니</a></li>
				<li><a href="/pageWep/board/myWrite.do">내가 쓴 글</a></li>
			</ul>
		</li>
	</td>
	<td>
	...
	<p class="title">Board</p>
		<ul> 
			<li><a href="/pageWep/board/list.do">글 목록</a></li>
			<li><a href="/pageWep/board/writeForm.do">글 쓰기</a></li>
			<li><a href="/pageWep/board/myWrite.do">내가 쓴 글</a></li>
		</ul>
	</li>
	</td>
	...
	<td>
	<li>                    
	<p class="title">Codination</p>
		<ul> 
			<li><a href="/pageWep/cboard/list.do">글 목록</a></li>
			<li><a href="/pageWep/cboard/writeForm.do">글 쓰기</a></li>
			<li><a href="/pageWep/cboard/myWrite.do">내가 쓴 글</a></li>
		</ul>
	</li>
	</td>
	<td>
	...
	<p class="title">Order</p>
		<ul> 
			<li><a href="/pageWep/member/modifyForm.do">배송정보 확인</a></li>
			<li><a href="/pageWep/member/deleteForm.do">내 구매 목록</a></li>
		</ul>
	</li>
	</td>
	</tr>
...
<ul>            
	...
	<td>
		<li>                    
		<p class="title">manage product</p>
			<ul> 
				<li><a href="/pageWep/product/prolist.do">상품리스트</a></li>
				<li><a href="/pageWep/product/prowriterForm.do">상품 등록</a></li>
				<li><a href="/pageWep/order/orderList.do">주문 리스트</a></li>
			</ul>
		</li>
	</td>
	</tr>
	...
	<td>
	<li>                    
	<p class="title">Management Member</p>
		<ul> 
			<li><a href="/pageWep/member/supervisemember.do">회원관리</a></li>
		</ul>
	</li>
	</td>
	</tr>
