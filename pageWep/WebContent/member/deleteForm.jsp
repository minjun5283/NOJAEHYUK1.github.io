...
<!-- 작업 부분   -->
<body onload ="begin()">
<form name = "myform" action="/pageWep/member/deletePro.do" method = "post" onsubmit="return checkIt()">
<table cellspacing ="0" cellpadding="5" width="250" border="1" align="center">
	<tr height="22">
		<td colspan="2" align="center" >
		<font size="+1">회원 탈퇴</font></td></tr>
	<tr height = "22">
	...
	<tr height = "22">
		...
		<input type="button" value="취 소" onclick="javascript:window.location='/pageWep/member/main.do'">
		<input type = "button" value="마이페이지" onclick="window.location='/pageWep/member/mypage.do'">
		</td>
	</tr>	 	
</table>
</form>
