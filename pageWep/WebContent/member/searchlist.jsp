...
<table border="1" width = "700"cellpadding="0" cellspacing ="0"align="center">
	...
	<c:if test="${sessionScope.memId == 'admin'}">
	<tr>
		<th align ="center" width="50">${c.id}</th>
		<th align ="center" width="50">${c.pw}</th>
		<th align ="center" width="50">${c.name}</th>
		<th align ="center" width="50">${c.phone}</th>
		<th align ="center" width="300">${c.address}</th>
	</tr>
	</c:if>
</table>
<center>
	<form action ="/pageWep/member/searchlist.do" method ="post">
	<font size ="4pt">아이디</font>
