...
<table width = "300" cellpadding="0" cellspacing="0" align="center" border="0">
	<tr> 
	<td  width ="300"align="center" colspan="2" height= "50">
	<font size="+1"><b>MEMBER LOGIN</b></font></td>
	
	</tr></br>
	
	<form name = "loginform" method = "post" action = "/pageWep/member/loginPro.do?state=${state}" onSubmit = "return checkIt()">
	<tr>
		<td  width ="50" height="25" align="left">ID</td>
		<td width ="250" height="25" align="left">
		<input type= "text" name ="id" size ="25" maxlength="15"></td>  
	</tr>
	<tr>
		<td width="50" height="25"align="left">PASSWARD</td>
		<td width = "250"  height="25" align="left">
		<input type = "password" name="pw" size="25" maxlength = "30"></td>
	</tr>
	...
	<tr>
		...
		<input type = "button" value = "JOIN" onclick = "window.location='/pageWep/member/inputForm.do'">
		<input type ="button" value="HOME" onClick="window.location='/pageWep/member/main.do'">
	</td>
	</tr>
