...
<table border="1" width = "700"cellpadding="0" cellspacing ="0"align="center">
	<tr>
		<th align ="center" width="50">아이디</th>
	...
	<tr>
		...
		<td align="center" width="100">${member.pw}</td>
		<td align="center" width="100">${member.name}</td>
		<td align="center" width="100">${member.phone}</td>
		<td align="center" width="300">${member.address}</td>
	</tr>
...
<center>
	<form action ="/pageWep/member/searchlist.do" method ="post">
	<font size = "4">아이디</font>
...
<!-- Footer -->
<footer>
	<p class="credits">&copy;글로벌아이티 인재개발 의류몰 <a href="" title="sitemap">사이트맵</a> by <a href="http://www.alessioatzeni.com/" title="Alessio Atzeni | Web Designer &amp; Front-end Developer">Alessio Atzeni</a></p>
</footer>
<!-- End Footer -->
