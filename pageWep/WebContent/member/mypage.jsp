...
<br/>
  	<hr>
  	<br/><br/>
   <center><font size="+4">MY PAGE</font><br/><br/>

    <tr><font size="+1">
    <a href="/pageWep/member/modifyForm.do"><font size="+2">정보수정</font></a><br/>
    <a href="/pageWep/member/deleteForm.do">회원 탈퇴</a><br/>
    <input type = "button" name="cart" value="Cart" onClick="javascript:window.location='/pageWep/cart/cart.do'"><br/>
    <input type = "button" name="myboard" value="주문"onClick="javascript:window.location='/pageWep/order/orderMypage.do'"><br/>
    </font>
    </tr>
    </center>
    <hr>
