...
<form method="post" action="prolistSelect.do">
<table>
<tr>
<td>
...
<option value="product_type">상품타입</option>
</select>
</td>
<td>
...
<c:if test="${count>0}">
   ...
   <a href="prolist.do?pageNum=${startPage - 10}">[이전]</a>
   </c:if>
   <c:forEach var="i" begin="${startPage}" end="${endPage}" step="1">
   <a href="prolist.do?pageNum=${i}">[${i}]</a>
   </c:forEach>
   <c:if test="${endPage < pageCount}">
   <a href="prolist.do?pageNum=${startPage + 10}">[다음]</a>
   </c:if>
</c:if>
