...
<table width="500" border="1" cellspacing="0" cellpadding="0" align="center">  
  <tr height="30">
    ...
    <td align="center" width="125" align="center">${article.board_num}</td>
  ...
  <tr height="30">
    ...
    <td align="center" width="125" align="center">${article.board_reg_date}</td>
  </tr>
  <tr height="30">
  ...
  <tr>
    ...
    <td align="left" width="375" colspan="3"><pre>${article.board_contents}</pre></td>
  </tr>
  <tr height="30">      
    <td colspan="4" align="right" > 
        <c:if test="${article.member_id == memId && memId != 'admin'}">
     <input type="button" value="글수정"    
       onclick="document.location.href='/pageWep/board/updateForm.do?num=${article.board_num}&pageNum=${pageNum}'">
      &nbsp;&nbsp;&nbsp;&nbsp;
     <input type="button" value="글삭제" 
       onclick="document.location.href='/pageWep/board/deleteForm.do?num=${article.board_num}&pageNum=${pageNum}'">
      &nbsp;&nbsp;&nbsp;&nbsp;
   </c:if>
     ...
     <input type="button" value="답글쓰기" 
      onclick="document.location.href='/pageWep/board/writeForm.do?num=${article.board_num}&ref=${article.board_ref}&re_step=${article.board_restep}&re_level=${article.board_relevel}'">
      &nbsp;&nbsp;&nbsp;&nbsp; 
      </c:if>
       <input type="button" value="글목록" 
       onclick="document.location.href='/pageWep/board/list.do?pageNum=${pageNum}'">
