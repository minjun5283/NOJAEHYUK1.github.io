...
<center><b>글수정</b>
<br>
<form method="post" name="writeform" action="/pageWep/board/updatePro.do?pageNum=${pageNum}" onsubmit="return writeSave()">
 <input type="hidden" name="writer" value="${article.member_id}">
<input type="hidden" name="num" value="${article.board_num}"></td>
<table width="400" border="1" cellspacing="0" cellpadding="0" align="center">      
  <tr>
    <td  width="70" align="center" >제 목</td>
    <td align="left" width="330">
       <input type="text" size="40" maxlength="50" name="subject" value="${article.board_subject}"></td>
  </tr>
  <tr>
    <td  width="70"  align="center" >내 용</td>
    <td align="left" width="330">
     <textarea name="content" rows="13" cols="40">${article.board_contents}</textarea></td>
  </tr>
  <tr>
